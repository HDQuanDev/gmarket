...
<body>
                    ...
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <h4 class="h5 fs-16 mb-1 fw-600"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="72434041464732155c15">[email&#160;protected]</a></h4>
                                <div class="text-truncate opacity-60"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="22131011161762450c45">[email&#160;protected]</a></div>
                            </div>
                            ...
                            <div class="col-md-4 mx-auto mb-3">
                                <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                                    ...
                                    <div class="px-3 pt-3 pb-3">
                                        <div class="h4 fw-700 text-center"><?= $user_money ?>$</div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table aiz-table mb-0">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * FROM history_payment WHERE user_id=$user_id ORDER by id desc");
                                        while ($row = fetch_assoc($sql)) {
                                        ?>
                                            <tr>
                                            <!-- <span class="footable-toggle fooicon fooicon-plus"></span> -->
                                                <td class="footable-first-visible" style="display: table-cell;"><?=$row['id']?></td>
                                                <td style="display: none;"><?=$row['create_date']?></td>
                                                <td style="display: table-cell;"><?=currency($row['amount'])?>$</td>
                                                <td style="display: none;"><?=$row['name_payment']?></td>
                                                <td class="text-right footable-last-visible" style="display: table-cell;">
                                                    <span class="badge badge-inline badge-<?=$row['status']=='Pending'?'info':($row['status']=='Success'?'success':'error')?>"><?=$row['status']?></span>
                                                </td>
                                            </tr>
                                        <?php } ?>
    ...
    <script type="text/javascript">
        ...
        function show_make_wallet_recharge_modal() {
            $.post('/users/offline-wallet-recharge-modal', {
                _token: 'U7iSZ5jtpBhCr9xYAfCgNijthESfoJA5mRBg7VqK'
            }, function(data) {
