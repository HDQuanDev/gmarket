...
<head>
    ...
    <meta name="csrf-token" content="W9PFHBTMBuYDdIrrgDTKtahBKZEcS36zE29Ll7vM">
                    ...
                    <div class="col-lg-6">
                        <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                            ...
                            <li class="text-dark fw-600 breadcrumb-item">
                                <a class="text-reset" href="/shops/create.php">"Register Your Shop"</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $refferal_admin_code=$_POST['refferal_admin_code'];
                            $shop_name=$_POST['shop_name'];
                            $address=$_POST['address'];

                            if($password!=$password_confirmation){
                                echo "<script>AIZ.plugins.notify('danger', 'Hai mật khẩu không khớp');</script>";
                            }
                            else{
                                $ExistCode=fetch_array("SELECT id FROM website_appearance WHERE referal_code='$refferal_admin_code' LIMIT 1");
                                if(!$ExistCode){
                                    echo "<script>AIZ.plugins.notify('danger', 'Mã giới thiệu không hợp lệ');</script>";
                                }
                                else{
                                    ...
                                    if($ExistUser)echo "<script>AIZ.plugins.notify('danger', 'Email đã tồn tại');</script>";
                                    else{
                                        @mysqli_query($conn,"INSERT into sellers(full_name,email,password,inviter,shop_name,shop_address)values('$name','$email','$password','$refferal_admin_code','$shop_name','$shop_address')");
                                        echo "<script>alert('Đăng kí thành công');window.location.href='/users/login'</script>";
                        ...
                        ?>
                        <form id="shop" class="" action="" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="W9PFHBTMBuYDdIrrgDTKtahBKZEcS36zE29Ll7vM">
                            <div class="bg-white rounded shadow-sm mb-3">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="form-group">
                                        <label>Referral Code <span class="text-primary">*</span></label>
                                        <input type="text" maxlength="8" minlength="6" class="form-control" placeholder="Referral Code" name="refferal_admin_code">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded shadow-sm mb-4">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="form-group">
                                        <label>Shop Address <span class="text-primary">*</span></label>
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary fw-600" name="submit">Register Your Shop</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML = "window.__CF$cv$params={r:'8d66fc2e6a24850f',t:'MTcyOTU3Mzg3MC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/public/assets/js/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
