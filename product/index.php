...
if(isset($_GET['product']) && $_GET['product']!=""){
    ...
    $p = fetch_array("SELECT * FROM products WHERE id='$product'");
    
    if($p){
        // If product exists in database, use it
        $dom = new DOMDocument;
...
<head>
    ...
    <meta name="app-url" content="//localhost/">
    <meta name="file-base-url" content="// /public/">

    <title>CASIO LTP-V007L-7B1 ANALOG ENTICER VINTAGE YOUTH WATER RESISTANT UNISEX SERIES WATCH</title>
    ...
    <meta itemprop="name" content="CASIO LTP-V007L-7B1 ANALOG ENTICER VINTAGE YOUTH WATER RESISTANT UNISEX SERIES WATCH">
    <meta itemprop="description" content="">
    <meta itemprop="image" content="//laz-img-sg.alicdn.com/p/65e988f00607e6bcea0c34b2f8c0cc3c.jpg">

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="product">
    <meta name="twitter:site" content="@publisher_handle">
    <meta name="twitter:title" content="CASIO LTP-V007L-7B1 ANALOG ENTICER VINTAGE YOUTH WATER RESISTANT UNISEX SERIES WATCH">
    <meta name="twitter:description" content="">
    <meta name="twitter:creator" content="@author_handle">
    <meta name="twitter:image" content="//laz-img-sg.alicdn.com/p/65e988f00607e6bcea0c34b2f8c0cc3c.jpg">
    <meta name="twitter:data1" content="26.04$">
    <meta name="twitter:label1" content="Price">

    <!-- Open Graph data -->
    <meta property="og:title" content="CASIO LTP-V007L-7B1 ANALOG ENTICER VINTAGE YOUTH WATER RESISTANT UNISEX SERIES WATCH" />
    <meta property="og:type" content="og:product" />
    <meta property="og:url" content="https://gmarketagents.com/product/judrh" />
    <meta property="og:image" content="//laz-img-sg.alicdn.com/p/65e988f00607e6bcea0c34b2f8c0cc3c.jpg" />
    <meta property="og:description" content="" />
    <meta property="og:site_name" content="GMARKETVN" />
    <meta property="og:price:amount" content="26.04$" />
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        ...
        <section class="mb-4 pt-3" style="display:none">
            <?php
            // $elements = $xpath->query("//section[contains(@class, 'mb-4 pt-3')]");
            // foreach ($elements as $element) {
            //     foreach ($element->childNodes as $child) {
            //         // In ra thẻ con
            //         if ($child->nodeType === XML_ELEMENT_NODE) {
            //             $c=str_replace("https://gmarketagents.com/","/",$dom->saveHTML($child));
            //             echo $c;
            //         }
            //     }
            // } 
        ...
        <section class="mb-4">
        <?php
            $elements = $xpath->query("//section[contains(@class, 'mb-4')]");
            foreach ($elements as $element) {
                foreach ($element->childNodes as $child) {
                    // In ra thẻ con
                    if ($child->nodeType === XML_ELEMENT_NODE) {
                        ...
                        if(strpos($c,'<input type="hidden" name="id"')){
                            //

                            $input = $xpath->query("//input[@name='id']");



                            $img = $xpath->query("//img[contains(@class, 'img-fluid lazyload')]");
                            $src = explode("#",$img->item(0)->getAttribute('data-src'))[0];


                            $price = trim(($xpath->query("//strong[contains(@class, 'h2 fw-600 text-primary')]"))->item(0)->nodeValue);
                            $name = trim(($xpath->query("//h1[contains(@class, 'mb-2 fs-20 fw-600')]"))->item(0)->nodeValue);
                            $max_limit = trim(($xpath->query("//span[@id='available-quantity']"))->item(0)->nodeValue);

                            // $price=1;
                            // $price=($xpath->query("//strong[contains(@class,'h2 fw-600 text-primary')]"));


                            $value = $input->item(0)->getAttribute('value');


                            $b=str_replace('<input type="hidden" name="id" value="'.$value.'">','<input type="hidden" name="img" value="'.$src.'">  <input type="hidden" name="max_limit" value="'.$max_limit.'">  <input type="hidden" name="price" value="'.$price.'">  <input type="hidden" name="name" value="'.$name.'">',$c);

                            // echo '<input type="hidden" name="id" value="44">jaaa';
                            echo $b;
    ...
    <div class="modal fade" id="chat_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                ...
                <form class="" action="https://gmarketagents.com/conversations" method="POST"
                    enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="JlzutnogSyCKt2B6LllzjNjRB78rPjZzHEytdpho"> <input type="hidden" name="product_id" value="1209">
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="title"
                                value="CASIO LTP-V007L-7B1 ANALOG ENTICER VINTAGE YOUTH WATER RESISTANT UNISEX SERIES WATCH" placeholder="Product Name"
                                required>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required
                                placeholder="Your Question">https://gmarketagents.com/product/judrh</textarea>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="/users/login/cart"
                            method="POST">
                            <input type="hidden" name="_token" value="JlzutnogSyCKt2B6LllzjNjRB78rPjZzHEytdpho">
                            <div class="form-group">
                                <input type="email"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-6 text-right">
                                    <a href="https://gmarketagents.com/password/reset"
                        ...
                        <ul class="list-inline social colored text-center mb-5">
                            <li class="list-inline-item">
                                <a href="https://gmarketagents.com/social-login/redirect/facebook"
                                    class="facebook">
                                    <i class="lab la-facebook-f"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://gmarketagents.com/social-login/redirect/google"
                                    class="google">
                                    <i class="lab la-google"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://gmarketagents.com/social-login/redirect/twitter"
                                    class="twitter">
                                    <i class="lab la-twitter"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://gmarketagents.com/social-login/redirect/apple"
                                    class="apple">
    ...
    <!-- SCRIPTS -->
    <script src="/public/assets/js/vendors.js?<?=time()?>"></script>
