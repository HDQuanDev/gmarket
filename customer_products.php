...
<body>
                ...
                <div class="d-flex align-items-start">
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <h4 class="h5 fs-16 mb-1 fw-600"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="86b7b4b5b2b3b0c6e1a8e1">[email&#160;protected]</a></h4>
                    ...
                    <div class="aiz-user-panel">
                        ...
                        <div class="row gutters-10">
                            ...
                            <div class="col-md-4 mx-auto mb-3">
                                <a href="/customer_products/create">
                            ...
                            <div class="col-md-4">
                                <a href="/customer-packages" class="text-center bg-white shadow-sm hov-shadow-lg text-center d-block p-3 rounded">
                                ...
                                <table class="table aiz-table mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-breakpoints="lg">Available Status</th>
    ...
    <script type="text/javascript">
        function update_status(el) {
            ...
            $.post('/customer_products/status', {
                _token: 'TohEyFqLbZc1M1LCWTXs2GqI9mbQdw0QMEUti8qf',
                id: el.value,
                status: status
            }, function(data) {
                if (data == 1) {
