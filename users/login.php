                            ...
                            <div class="card">
                                ...
                                if(isset($_POST['email']) && isset($_POST['password'])){
                                    ...
                                    if($checkExist){
                                        ...
                                        $checkExist1=fetch_array("SELECT * FROM sellers WHERE email='$email' and password='$password' LIMIT 1");
                                        if($checkExist1){
                                            $_SESSION['seller_id']=$checkExist1['id'];
                                            echo "<script>alert('Đăng nhập thành công');window.location.href='/seller'</script>";
                                        }
                                        else echo "<script>alert('Tài khoản không hợp lệ');</script>";
                                    }
                                }
                                ?>
                                <div class="px-4 py-3 py-lg-4">
                                    <div class="">
                                        <form class="form-default" role="form" action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="" placeholder="Email" name="email" id="email" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-6">
                                                    <label class="aiz-checkbox">
                                                        ...
                                                        <span class=opacity-60><?=tran("Remember Me")?></span>
                                                        <span class="aiz-square-check"></span>
                                                    </label>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <a href="/password/reset" class="text-reset opacity-60 fs-14"><?=tran("Forgot password")?>?</a>
                                                </div>
                                            </div>

                                            <div class="mb-5">
                                                <button type="submit" class="btn btn-primary btn-block fw-600"><?=tran("Login")?></button>
                                            </div>
                                        </form>


                                        <div class="separator mb-3">
                                            <span class="bg-white px-3 opacity-60"><?=tran("Or Login With")?></span>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <p class="text-muted mb-0"><?=tran("Dont have an account")?>?</p>
                                        <a href="/users/registration"><?=tran("Register Now")?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
