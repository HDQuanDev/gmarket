...
<head>
    ...
    <meta name="csrf-token" content="KbkZ4klXSCw7fnX2S3EFMdrgkNJ7IRQa79431S8K">
                    ...
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <div class="text-truncate opacity-60"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="79484b4a4d4c4f391e571e">[email&#160;protected]</a></div>
                            </div>
                        ...
                        <div class="fixed-bottom d-xl-none bg-white border-top d-flex justify-content-between px-2"
                            ...
                            <a class="btn btn-sm p-2 d-flex align-items-center" href="https://tmdtquocte.com/logout">
