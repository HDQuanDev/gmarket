        ...
        <section class="py-4 py-lg-5">
            <div class="container">
                <div class="row row-cols-xxl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 gutters-10 justify-content-center">
                        ...
                        <?php 
                        $sql=mysqli_query($conn,"SELECT * FROM customer_packages");
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="text-center mb-4 mt-3">
                                    <img alt="Package Logo" src="/public<?=$logo?'/uploads/all/'.$logo['src']:'/assets/img/placeholder.jpg'?>" class="mw-100 mx-auto mb-4" height="100px">
                                    <h5 class="mb-3 h5 fw-600"><?=$row['name']?></h5>
                                </div>
                                <ul class="list-group list-group-raw fs-20 mb-5">
                                    <li class="list-group-item py-2">
                                        <i class="las la-check text-success mr-2"></i>
                                        <?=$row['product_upload_limit']?> Product Upload
                                    </li>
                                </ul>
                                ...
                                <div class="text-center">
                                    <button class="btn btn-primary" onclick="get_free_package(1)">Free Package</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function payment_type(type) {
            ...
            if (type == 'online') {
                ...
                $("#select_type_cancel").click();
                $.post('/offline-customer-package-purchase-modal', {
                    _token: '4f5MLkwyl37w2ajfpKCbQjxbVPi35vsvCctPNncF',
