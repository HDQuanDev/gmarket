...
<body class="">
                    ...
                    <div class="aiz-titlebar text-left mt-2 mb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-md-right">
                                <a href="/admin/uploads/create.php" class="btn btn-primary">
                    ...
                    <div class="card">
                        <form id="sort_uploads" action="">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                $sql=mysqli_query($conn,"SELECT * FROM file WHERE user_id=$user_id ORDER by id desc");
                                while($row=fetch_assoc($sql)){
                                    $src1=explode(".",$row['src']);
                                ?>
                                    ...
                                    <div class="col-auto w-140px w-lg-220px">
                                        <div class="aiz-file-box">
                                            ...
                                            <div class="card card-file aiz-uploader-select c-default" title="<?=$row['src']?>">
                                                <div class="card-file-thumb">
                                                    <img src="/public/uploads/all/<?=$row['src']?>" class="img-fit">
                                                </div>
                                                <div class="card-body">
                                                    <h6 class="d-flex">
                                                        <span class="text-truncate title"><?=$src1[0]?></span>
                                                        <span class="ext">.<?=$src1[count($src1)-1]?></span>
                                                    </h6>
                                                    <p><?=formatFileSize($row['size'])?></p>
                                                    <!-- <p>34.46 KB</p> -->
    ...
    <script type="text/javascript">
        function detailsInfo(e) {
            ...
            $.post('/admin/uploads/file_info.php', {
        ...
        function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "/seller/bulk-uploaded-files-delete",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
