                    ...
                    <div class="col-lg-10 mx-auto">
                        <div class="card">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                @mysqli_query($conn,"INSERT into seller_packages(name,amount,duration,logo,product_upload_limit,create_date)values('$name','$amount','$duration','$logo','$product_upload_limit','$createDate')");
                                echo "<script>window.location.href='/admin/sellers/seller_packages.php'</script>";
