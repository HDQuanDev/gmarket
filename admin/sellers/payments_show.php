...
<head>
    <meta name="csrf-token" content="5hhVUhnDJQDMzznrvw6SAAsK0idqIPZC23C0XmnA">
                ...
                <div class="px-15px px-lg-25px">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">usertest5 (usertest5)</h5>
                        </div>
                        <div class="card-body">
        ...
        if ($('#lang-change').length > 0) {
            $('#lang-change .dropdown-menu a').each(function() {
                $(this).on('click', function(e) {
                    ...
                    $.post('/language', {
                        _token: '5hhVUhnDJQDMzznrvw6SAAsK0idqIPZC23C0XmnA',
                        locale: locale
                    }, function(data) {
                        location.reload();
                    });
