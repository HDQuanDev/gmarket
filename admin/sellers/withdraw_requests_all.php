...
<body class="">
                ...
                <div class="px-15px px-lg-25px">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">Seller Withdraw Request</h5>
                        </div>
                        <div class="card-body">
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    $sql=mysqli_query($conn,"SELECT * FROM history_payment WHERE seller_id is not null and type='Withdraw' and id>($page-1)*10 and id<=$page*10 ");
    ...
    <script type="text/javascript">
        function show_seller_payment_modal(id, seller_withdraw_request_id, cancel) {
            var cancels = '';
            if (cancel) {
                cancels = cancel;
            }
