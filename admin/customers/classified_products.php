...
<body class="">
                ...
                <div class="px-15px px-lg-25px">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6"><?=tran("Classified Products")?></h5>
                        </div>
                        <div class="card-body">
                            <table class="table aiz-table mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?=tran("Name")?></th>
                                        <th data-breakpoints="lg"><?=tran("Image")?></th>
                                        <th data-breakpoints="lg"><?=tran("Uploaded By")?></th>
                                        <th data-breakpoints="lg"><?=tran("Customer Status")?></th>
                                        <th data-breakpoints="lg"><?=tran("Published")?></th>
                                        <th class="text-right" width="10%"><?=tran("Options")?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <script type="text/javascript">
        ...
        function update_published(el) {
            ...
            $.post('/admin/classified_products/published', {
