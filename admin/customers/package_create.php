                    ...
                    <div class="col-lg-10 mx-auto">
                        <div class="card">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                @mysqli_query($conn,"INSERT into customer_packages(name,amount,logo,product_upload_limit,create_date)values('$name','$amount','$logo','$product_upload_limit','$createDate')");
                                echo "<script>window.location.href='/admin/customers/packages.php'</script>";
                            ...
                            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" min="0" step="1" placeholder="Product Upload Limit" id="product_upload_limit" name="product_upload_limit" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
