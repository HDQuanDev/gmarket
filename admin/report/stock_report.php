                    ...
                    <div class="row">
                        <div class="col-md-8 mx-auto">
                            <div class="card">
                                <!--card body-->
                                <div class="card-body">
                                    <form action="#/admin/stock_report" method="GET">
                                    ...
                                    <table class="table table-bordered aiz-table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Bestheim Healthier Basic Air Fryer 6L</td>
                                                <td>2309</td>
                                            </tr>
                                            <tr>
                                                <td>Samsung Electronics Wired Mouse SPA-JMA1PUB</td>
                                                <td>17542</td>
                                            </tr>
                                            <tr>
                                                <td>Philips Mini Blender Blender HR2604/80</td>
                                                <td>20318</td>
                                            </tr>
                                            <tr>
                                                <td>Stainless Steel Soup Pot Steam Piece Home Multi-functional Steam Pot Opening Gift</td>
                                                <td>855</td>
                                            </tr>
                                            <tr>
                                                <td>Ultra-low-power household electric mosquito repellent / mayfly pest repellent</td>
                                                <td>9632</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="aiz-pagination mt-4">
                                        <nav>
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=2">2</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=3">3</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=4">4</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=5">5</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=6">6</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=7">7</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=8">8</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=9">9</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=10">10</a></li>
                                                ...
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=2391">2391</a></li>
                                                <li class="page-item"><a class="page-link" href="h/admin/stock_report.php?page=2392">2392</a></li>


                                                <li class="page-item">
                                                    <a class="page-link" href="h/admin/stock_report.php?page=2" rel="next" aria-label="Next »">&rsaquo;</a>
                                                </li>
                                            </ul>
                                        </nav>
