...
<head>
    ...
    <meta name="csrf-token" content="t40NM5KWomwPYTwo4YwoJ32azD42uDyngpog8ugv">
                    ...
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <h4 class="h5 fs-16 mb-1 fw-600">Truong</h4>
                                <div class="text-truncate opacity-60"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1d2c2f2e29282b5d7a337a">[email&#160;protected]</a></div>
                            </div>
                            ...
                            <div class="card-header row gutters-5">
                                <div class="text-center text-md-left">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <span class="badge badge-inline badge-<?=$support['status']=='Pending'?"danger":"secondary"?> ml-2"> <?=$support['status']?> </span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                if(isset($_POST['ticket_id']) && isset($_POST['reply'])){
                                    ...
                                    @mysqli_query($conn,"INSERT into support_details(support_id,user_id,details,files)values('{$_GET['id']}','$user_id','$reply','$attachments')");
                                    @mysqli_query($conn,"UPDATE supports SET last_reply='$createDate' WHERE id='{$_GET['id']}' LIMIT 1");
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="t40NM5KWomwPYTwo4YwoJ32azD42uDyngpog8ugv"> <input type="hidden" name="ticket_id" value="<?=$_GET['id']?>" required>
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <span class="avatar avatar-sm mr-3">
                                                        ...
                                                        <img src="/public/uploads/all/gTpdv1822yoHhDKtwGLenMSNg19P86n99DzgA91a.jpg" onerror="this.onerror=null;this.src='/public/assets/img/avatar-place.png';">
                                                        <?php }else{?>
                                                ...
                                                <div class="media-body">
                                                    <div class="comment-header">
                                                        <span class="text-bold h6 text-muted"><?=$row['type']=='admin'?"Admin":$user['full_name']?></span>
                                            ...
                                            <div>
                                                ...
                                                <?php
                                                    ...
                                                    <a href="/public/uploads/all/<?=$file['src']?>" download="" class="badge badge-lg badge-inline badge-light mb-1">
                                                        <i class="las la-download text-muted"><?=$file['src']?></i>
                                                    </a>
                                                    <br>
                                                    <?php }?>
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML = "window.__CF$cv$params={r:'8d5a21317a72e2e6',t:'MTcyOTQzOTA3MS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
