...
if (!$isLogin) header("Location: /users/login");else if($isSeller) header("Location: /seller/index.php") ?>
...
<head>
    ...
    <meta name="csrf-token" content="U7iSZ5jtpBhCr9xYAfCgNijthESfoJA5mRBg7VqK">
                    ...
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <div class="text-truncate opacity-60"><?= $user_phone == "" ? $user_email : $user_phone ?></div>
                            </div>
                    ...
                    <div class="aiz-user-panel">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($password = $user_password) {
                                ...
                                @mysqli_query($conn, "UPDATE users SET full_name='$new_name',phone='$phone' WHERE id=$user_id LIMIT 1");
                                echo "<script>alert('Update thành công')</script>";
                            } else {
                                echo "<script>alert('Mật khẩu của bạn không hợp lệ')</script>";
                            }
                        }
                        ?>
                        <form action="" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="U7iSZ5jtpBhCr9xYAfCgNijthESfoJA5mRBg7VqK"> <!-- Basic Info-->
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required placeholder="Your name" name="name" value="<?= $user_name ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required placeholder="Your Phone" name="phone" value="<?= $user_phone ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="row gutters-10">
                                    ...
                                    if(isset($_GET['action']) && isset($_GET['id'])){
                                        ...
                                        if($action=="set_default"){
                                            @mysqli_query($conn,"UPDATE address set is_default=0 WHERE user_id=$user_id");
                                            @mysqli_query($conn,"UPDATE address set is_default=1 WHERE  user_id=$user_id and id=$id LIMIT 1");
                                        }
                                        else if($action=="destroy"){
                                            @mysqli_query($conn,"DELETE FROM address WHERE user_id=$user_id and id=$id LIMIT 1");
                                        }
                                    ...
                                    $sql=mysqli_query($conn,"SELECT * FROM address WHERE id=$user_id ");
                                    ...
                                    <div class="col-lg-6">
                                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                            ...
                                            <div>
                                                ...
                                                <span class="ml-2"><?=$row['post_code']?></span>
                                            </div>
                                            <div>
                                            ...
                                            <div class="position-absolute right-0 bottom-0 pr-2 pb-3">
                                                <span class="badge badge-inline badge-primary">Mặc định</span>
                                            </div>
                                            <?php }?>
                                            ...
                                            <div class="dropdown position-absolute right-0 top-0">
                                                ...
                                                <button class="btn bg-gray px-2" type="button" data-toggle="dropdown" aria-expanded="false">
                                                    <i class="la la-ellipsis-v"></i>
                                                </button>
                                                
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style="">
                                                    <a class="dropdown-item" onclick="edit_address('<?=$row['id']?>')">
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item" href="/profile?action=set_default&id=<?=$row['id']?>">Make This Default</a>
                                                    <a class="dropdown-item" href="/profile?action=destroy&id=<?=$row['id']?>">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form action="/new-user-email" method="POST">
                            <input type="hidden" name="_token" value="U7iSZ5jtpBhCr9xYAfCgNijthESfoJA5mRBg7VqK">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group mb-3">
                                                <input type="email" class="form-control" placeholder="Your Email" name="email" value="<?= $user_email ?>" />
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2">
                                    ...
                                    <span class="d-block opacity-70">
                                        <a href="/cdn-cgi/l/email-protection#f3859a96879d929e949e9281989687c3c5cbb3949e929a9fdd909c9e" class="text-reset"><span class="__cf_email__" data-cfemail="d2a4bbb7a6bcb3bfb5bfb3a0b9b7a6e2e4ea92b5bfb3bbbefcb1bdbf">[email&#160;protected]</span></a>
                                    </span>
                                </li>
                            </ul>
                        </div>
...
<ul class="list-unstyled">
                ...
                <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                        <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                            ...
                            <h4 class="h5 fs-16 mb-1 fw-600"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d3c3f3e39384d6a236a">[email&#160;protected]</a></h4>
                            <div class="text-truncate opacity-60"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="48797a7b7c7d082f662f">[email&#160;protected]</a></div>
                        </div>
                        ...
                        <div class="sidemnenu mb-3">
                            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="/profile" class="aiz-side-nav-link active">
    ...
    <div class="modal fade" id="new-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="form-default" role="form" action="/addresses" method="POST">
                    <input type="hidden" name="_token" value="U7iSZ5jtpBhCr9xYAfCgNijthESfoJA5mRBg7VqK">
                    <div class="modal-body">
                        <div class="p-3">
                            <div class="row">
    ...
    <script type="text/javascript">
        ...
        function edit_address(address) {
            var url = 'users/address_edit.php?id=:id';
        ...
        function get_states(country_id) {
            ...
            $.ajax({
                ...
                url: `/users/get_states.php?country=${country_id==231?"USA":"VN"}`,
                type: 'POST',
                data: {
