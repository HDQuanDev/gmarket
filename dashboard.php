...
<?php include("./config.php");if(!$isLogin)header("Location: /users/login");?>
                    ...
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <h4 class="h5 fs-16 mb-1 fw-600"><?=$user_phone?></h4>
                        ...
                        <div class="row gutters-10">
                            ...
                            <div class="col-md-4">
                                <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                                    <div class="px-3 pt-3">
                                        <div class="h3 fw-700"><?=$count_wishlist?> Products</div>
                            ...
                            <div class="col-md-4">
                                <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                                    <div class="px-3 pt-3">
                                        <div class="h3 fw-700"><?=$count_ordered?> Products</div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <?php 
                                        $checkExist=fetch_array("SELECT * FROM address WHERE is_default=1 and user_id=$user_id ");
                                        if($checkExist){
                                        ?>
                                        <li class=" py-2"><span>Địa chỉ : <?=$checkExist['address']?></span></li>
                                        <li class=" py-2"><span>Mã bưu điện : <?=$checkExist['post_code']?></span></li>
                                        <li class=" py-2"><span>Điện thoại : <?=$checkExist['phone']?></span></li>
                                        <?php }?>
                                    </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <a href="/customer-packages" class="btn btn-success d-inline-block">Upgrade Package</a>
                                    </div>
                                </div>
                            </div>
                        </div>
