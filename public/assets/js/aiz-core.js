    ...
    AIZ.uploader = {
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    ...
                                    AIZ.uploader.getAllUploads(
                                        AIZ.data.appUrl +
                                            "/aiz-uploader/get_uploaded_files.php"
                                    );
        ...
        showSelectedFiles: function () {
            $('[name="aiz-show-selected"]').on("change", function () {
                if ($(this).is(":checked")) {
                    ...
                    // }
                    AIZ.uploader.getAllUploads(
                        AIZ.data.appUrl + "/aiz-uploader/get_uploaded_files.php"
                    );
                }
                AIZ.uploader.updateUploaderFiles();
            });
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                ...
                $.post(
                     "/aiz-uploader/get_file_by_ids.php",
        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.use(Uppy.XHRUpload, {
                    endpoint: "/aiz-uploader/upload.php",
                    fieldName: "aiz_file",
                    formData: true,
                    headers: {
