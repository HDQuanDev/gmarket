...
$last=fetch_array("SELECT * FROM orders WHERE user_id=$user_id  ORDEr by id desc  LIMIT 1 ");
if(!$last){
...
<body>
                ...
                <div class="row">
                    <div class="col-xl-8 mx-auto">
                        <div class="text-center py-4 mb-4">
                            ...
                            <p class="opacity-70 font-italic">A copy or your order summary has been sent to <?=$user_email?></p>
                        </div>
                        ...
                        <div class="card shadow-sm border-0 rounded">
                            <div class="card-body">
                                <div class="text-center py-4 mb-4">
                                    <h2 class="h5">Order Code: <span class="fw-700 text-primary"><?=$last['code']?></span></h2>
                                </div>
                                <div>
                                    ...
                                    <div>
                                        <table class="table table-responsive-md">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql=mysqli_query($conn,"SELECT * FROM detail_orders WHERE order_id='{$last['id']}' ");
                                                ...
                                                <tr>
                                                    <td>1</td>
                                                    <td>
                                                        <!-- <a href="https://tmdtquocte.com/product/iphone-15-pro-max-sG35i-6glAh-Ol1sP" target="_blank" class="text-reset"> -->
                                                            <?=$row['name']?>
                                                        <!-- </a> -->
                                                    </td>
                                                    <td>
                                            ...
                                            <table class="table ">
                                                <tbody>
                                                    <tr>
                                                        <th>Subtotal</th>
                                                        <td class="text-right">
                                                            <span class="fw-600"><?=$last['amount']?>$</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Shipping</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <strong><span><?=$last['amount']?>$</span></strong>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
    ...
    <script>
        AIZ.plugins.notify('success', 'Your order has been placed successfully. Please submit payment information from purchase history');
    </script>
    ...
    <script type="text/javascript">
        function show_order_details(order_id) {
            ...
            $.post('https://tmdtquocte.com/admin/orders/details', {
                _token: AIZ.data.csrf,
                order_id: order_id
            }, function(data) {
