...
<head>
    ...
    <meta name="csrf-token" content="3FkoRUh6q8RcaCpHE6pFpIDsJp9DuzKY1JXZUlxs">
...
<body>
            ...
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-xxl-8 col-xl-10 mx-auto">
                        <form class="form-default" data-toggle="validator" action="/checkout/delivery_info" role="form" method="POST">
                            <input type="hidden" name="_token" value="ZO2mNEWnUXeD3DmuiKXl7GetJjx6VF1YLLg8ze8R">
                            <div class="shadow-sm bg-white p-4 rounded mb-4">
                                <div class="row gutters-5">

                                    <?php 
                                    $sql=mysqli_query($conn,"SELECT * FROM address WHERE user_id=$user_id ");
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    <div>
                                                        ...
                                                        <span class="fw-600 ml-2"><?=$row['address']?></span>
                                                    </div>
                                                    <div>
                                                        <span class="opacity-60">Postal code:</span>
                                                        <span class="fw-600 ml-2"><?=$row['post_code']?></span>
                                                    </div>
                                                    <!--<div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="fw-600 ml-2"><?=$row['phone']?></span>
                                                    </div>
                                                </span>
                                            </span>
                                        </label>
                                        <div class="dropdown position-absolute right-0 top-0" style="display:none">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-center text-md-right">
                                    <button type="submit" class="btn btn-primary fw-600">Continue to Delivery Info
                                    </button>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                if(isset($_POST['new_address'])){
                    ...
                    echo "<script>alert('Thêm thành công');window.location.href='/checkout'</script>";

                }
                ?>
                <form class="form-default" role="form" action="" method="POST">
                    <input type="hidden" name="_token" value="3FkoRUh6q8RcaCpHE6pFpIDsJp9DuzKY1JXZUlxs">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group text-right">
                                <button type="submit" name="new_address" class="btn btn-sm btn-primary">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script>
        ...
        function addToWishList(id) {
            $.post('https://tmdtquocte.com/wishlists', {
                _token: AIZ.data.csrf,
                id: id
            }, function(data) {
                if (data != 0) {
    ...
    <script type="text/javascript">
        ...
        function get_states(country_id) {
            alert(1);
            $('[name="state"]').html("");
            fetch(`/users/get_states.php?country=${country_id}`).then(r=>r.text()).then(data=>{
                console.log(data);
                // document.getElementById('edit_state').innerHTML=data;
            ...
            $.ajax({
                ...
                url: `/users/get_states.php?country=${country_id}`,
                type: 'POST',
                data: {
        ...
        function get_city(state_id) {
            ...
            $.ajax({
                ...
                url: "https://tmdtquocte.com/get-cities",
                type: 'POST',
                data: {
                    state_id: state_id
                },
