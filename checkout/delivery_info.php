...
<head>
    ...
    <meta name="csrf-token" content="yxfySDBGkxEiLFEWTACstoxtMEpEtqUUjcREjtSN">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-8 col-xl-10 mx-auto">
                        <form class="form-default" action="/checkout/payment_select" role="form" method="POST">
                            <input type="hidden" name="_token" value="yxfySDBGkxEiLFEWTACstoxtMEpEtqUUjcREjtSN">
                            <input type="hidden" name="address_id" value="<?=$_POST['address_id']?>">

                            <div class="card mb-3 shadow-sm border-0 rounded">
                                <div class="card-header p-3">
                                    <h5 class="fs-16 fw-600 mb-0">a-zstore Products</h5>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row gutters-5">
                                                <div class="col-6">
                                                    <label class="aiz-megabox d-block bg-white mb-0">
                                                        <input
                                                            type="radio"
                                                            name="shipping_type_1898"
                                                            value="home_delivery"
                                                            onchange="show_pickup_point(this, 1898)"
                                                            data-target=".pickup_point_id_1898"
                                                            checked>
