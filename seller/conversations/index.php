                ...
                <div class="px-15px px-lg-25px">
                    <div class="aiz-titlebar mt-2 mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <b class="h4"><?=tran("Conversations")?></b>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <?php
                                $sql=mysqli_query($conn,"SELECT * FROM conversations WHERE seller_id='$seller_id'");
                                while($row=fetch_assoc($sql)){
                                    $p=fetch_array("SELECT * FROM products WHERE id='{$row['product_id']}' LIMIT 1");
                                        ...
                                        <div class="col-auto">
                                            <div class="media">
                                                <span class="avatar avatar-sm flex-shrink-0">
                                                    <img src="/public/assets/img/avatar-place.png" onerror="this.onerror=null;this.src='/public/assets/img/avatar-place.png';">
                                                </span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="block-body">
                                                <div class="block-body-inner pb-3">
                                                    <div class="row no-gutters">
                                                        <div class="col">
                                                            <h6 class="mt-0">n.
                                                                <a href="./detail.php?id=<?=$row['id']?>" class="text-dark fw-600">
                                                                    <?=$p['name']?>
                                                                </a>
