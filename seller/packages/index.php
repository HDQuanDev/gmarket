                    ...
                    <section class="py-4 py-lg-5">
                        <div class="container">
                            <div class="row row-cols-xxl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 gutters-10 justify-content-center">
                                <?php
                                $sql = mysqli_query($conn, "SELECT  * FROM seller_packages");
                                        ...
                                        <div class="card overflow-hidden">
                                            <div class="card-body">
                                                <div class="text-center mb-4 mt-3">
                                                    <img class="mw-100 mx-auto mb-4" src="/public<?= $logo ? '/uploads/all/' . $logo['src'] : '/assets/img/placeholder.jpg' ?>" height="100">
                                                    <h5 class="mb-3 h5 fw-600">Bronze Shop</h5>
                                                </div>
                                                ...
                                                <div class="mb-5 d-flex align-items-center justify-content-center">
                                                    <span class="fs-30 fw-600 lh-1 mb-0"><?=$row['amount']==0?"Free":$row['amount']."$"?></span>
                                                    <span class="text-secondary border-left ml-2 pl-2"><?=$row['duration']?><br>Days</span>
                                                </div>

                                                <div class="text-center">
                                                    <?php if($row['amount']==0 ){?>
                                                    <button class="btn btn-primary fw-600" onclick="get_free_package(<?=$row['id']?>)">Free Package</button>
                                                    <?php }else{?>
                                                    <button class="btn btn-primary fw-600" onclick="select_payment_type(<?=$row['id']?>)">Purchase Package</button>
                                                    <?php }?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" id="package_payment_form_" action="/seller/offline-seller-package-paymnet"
                        method="post">
                        <input type="hidden" name="_token" value="c6MXnpe4lPP7N32uzv6W24NEiPEWxjq4Y54fVWYP"> <input type="hidden" id="package_id" name="package_id" value="">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select class="form-control aiz-selectpicker">
                                        <option value="">Use Wallet Balance ($<?=$seller_money?>)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="" id="package_payment_form" action="/seller_packages/purchase"
                    method="post">
                    <input type="hidden" name="_token" value="c6MXnpe4lPP7N32uzv6W24NEiPEWxjq4Y54fVWYP"> <input type="hidden" name="seller_package_id" value="">
    ...
    <script type="text/javascript">
        ...
        function payment_type(type) {
            ...
            if (type == 'online') {
                ...
                $("#select_type_cancel").click();
                $.post('/seller/offline-seller-package-purchase-modal', {
