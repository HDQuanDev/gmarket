...
$product_id=$_GET['id'];
$product=fetch_array("SELECT * FROM products WHERE id=$product_id and seller_id=$seller_id LIMIT 1");
            ...
            <div class="aiz-main-content">
                <div class="px-15px px-lg-25px">
                    ...
                    if(isset($_POST['submit']) ){
                        ...
                        @mysqli_query($conn,"UPDATE products SET description='$description',discount='$discount',rose='$rose',profit='$profit',purchase_price='$purchase_price',unit_price='$unit_price',meta_description='$meta_description',meta_image='$meta_img',meta_title='$meta_title',thumbnail_image='$thumbnail_img',gallery_images='$photos',tags='$tags',files='$file',category_id='$category_id',name='$name' WHERE id='{$_GET['id']}' LIMIT 1" );
                    ...
                    <form class="" action="" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="card mb-0 border-bottom-0">
                            <div class="card-body p-0" style="display:none">
                                <ul class="nav nav-tabs nav-fill border-light" >
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  active  py-3" href="/seller/digitalproducts/28113/edit?lang=en">
                                            <img src="/public/assets/img/flags/en.png" height="11" class="mr-1">
                                            <span>English</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=cn">
                                            <img src="/public/assets/img/flags/cn.png" height="11" class="mr-1">
                                            <span>中文</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=kr">
                                            <img src="/public/assets/img/flags/kr.png" height="11" class="mr-1">
                                            <span>Korea</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=ru">
                                            <img src="/public/assets/img/flags/ru.png" height="11" class="mr-1">
                                            <span>Russia</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=in">
                                            <img src="/public/assets/img/flags/in.png" height="11" class="mr-1">
                                            <span>India</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=ae">
                                            <img src="/public/assets/img/flags/ae.png" height="11" class="mr-1">
                                            <span>UAE</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=jp">
                                            <img src="/public/assets/img/flags/jp.png" height="11" class="mr-1">
                                            <span>Japan</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=th">
                                            <img src="/public/assets/img/flags/th.png" height="11" class="mr-1">
                                            <span>Thailand</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=br">
                                            <img src="/public/assets/img/flags/br.png" height="11" class="mr-1">
                                            <span>Brazil</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=vn">
                                            <img src="/public/assets/img/flags/vn.png" height="11" class="mr-1">
                                            <span>Vietnam</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=sg">
                                            <img src="/public/assets/img/flags/sg.png" height="11" class="mr-1">
                                            <span>Singapore</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=my">
                                            <img src="/public/assets/img/flags/my.png" height="11" class="mr-1">
                                            <span>Malaysia</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=fr">
                                            <img src="/public/assets/img/flags/fr.png" height="11" class="mr-1">
                                            <span>France</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3" href="/seller/digitalproducts/28113/edit?lang=de">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group" data-toggle="aizuploader" data-multiple="false">
                                            ...
                                            <input type="hidden" name="file" class="selected-files" value="<?=$product['files']?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control aiz-tag-input" name="tags[]" id="tags" value="#vinfast" placeholder="Type to add a tag">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                            ...
                                            <div class="form-control file-amount">Choose File</div>
                                            <input type="hidden" name="photos" value="<?=$product['gallery_images']?>" class="selected-files" required>
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                            ...
                                            <div class="form-control file-amount">Choose File</div>
                                            <input type="hidden" name="thumbnail_img" value="<?=$product['thumbnail_image']?>" class="selected-files" required>
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                            ...
                                            <div class="form-control file-amount">Choose File</div>
                                            <input type="hidden" name="meta_img" value="<?=$product['meta_image']?>" class="selected-files">
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-from-label">Slug</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="slug" value="<?=$product['slugs']?>" placeholder="Slug">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-from-label">Purchase price</label>
                                    <div class="col-lg-9">
                                        <input type="number" lang="en" min="0" step="0.01" placeholder="Purchase price" name="purchase_price" class="form-control" value="<?=$product['purchase_price']?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" lang="en" min="0" step="0.01" placeholder="Tax" name="profit" class="form-control" value="<?=$product['profit']?>" required>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" lang="en" min="0" step="0.01" placeholder="Tax" name="rose" class="form-control" value="<?=$product['rose']?>" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <select class="form-control aiz-selectpicker" name="tax_type[]" required>
                                            <option value="amount" selected>Flat</option>
