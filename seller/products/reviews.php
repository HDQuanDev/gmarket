...
<html lang="en">
<head>
	<meta name="csrf-token" content="sY3tzsrJ2efBsz6gfCOaAFhO1F38qubVTunRAMoB">
	...
	<!-- aiz core css -->
	<link rel="stylesheet" href="https://gmarketagents.com/public/assets/css/vendors.css">
    	<link rel="stylesheet" href="https://gmarketagents.com/public/assets/css/aiz-seller.css">
...
<body class="">
    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <div class="d-block text-center my-3">
                                    <img class="mw-100 mb-3" src="https://gmarketagents.com/public/uploads/all/cQ1q3AsmLxInjHd0FSqEAMtmZAWzyto08IaBGbvW.jpg" class="brand-icon"
                        alt="Gmarket Viet Nam">
                                <h3 class="fs-16  m-0 text-primary">Shop Vân Nhi sotre</h3>
                <p class="text-primary">shopvannhi12@gmail.com</p>
                <p class="text-primary fs-14">Credit Score: 100</p>
            </div>
        </div>
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/dashboard" class="aiz-side-nav-link">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarketagents.com/seller/products"
                        ...
                        <!--<li class="aiz-side-nav-item">
                            <a href="https://gmarketagents.com/seller/product-bulk-upload/index"
                                class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Product Bulk Upload</span>
                            </a>
                        </li>-->
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarketagents.com/seller/digitalproducts"
                                class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Digital Products</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarketagents.com/seller/reviews"
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/uploads"
                        class="aiz-side-nav-link ">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="https://gmarketagents.com/seller/seller-packages" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">Packages</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="https://gmarketagents.com/seller/packages-payment-list" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                    <li class="aiz-side-nav-item">
                                        <a href="https://gmarketagents.com/seller/seller-through-train" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">Through Train</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="https://gmarketagents.com/seller/through-train-payment-list" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="https://gmarketagents.com/seller/pos"
                                    class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                                                        <a href="https://gmarketagents.com/seller/orders"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/shop"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/payments"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/money-withdraw-requests"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/money-recharge-requests"
                        class="aiz-side-nav-link ">
                        <i class="las la-money-bill-wave-alt aiz-side-nav-icon"></i>
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/commission-history" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">Commission History</span>
                                                        ...
                                                        <li class="aiz-side-nav-item">
                        <a href="https://gmarketagents.com/seller/conversations"
                            class="aiz-side-nav-link ">
                            ...
                            <span class="aiz-side-nav-text">Conversations</span>
                                    ...
                                    <li class="aiz-side-nav-item">
                        <a href="https://gmarketagents.com/seller/product-queries"
                            class="aiz-side-nav-link ">
                            ...
                            <span class="aiz-side-nav-text">Product Queries</span>
                                ...
                                <li class="aiz-side-nav-item">
                    <a href="https://gmarketagents.com/seller/support_ticket"
                        class="aiz-side-nav-link ">
            ...
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle btn-light" href="https://gmarketagents.com" target="_blank" title="Browse Website">
                    ...
                    <div class="aiz-topbar-item">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-icon btn-circle btn-light" href="https://gmarketagents.com/seller/pos" target="_blank" title="POS">
                ...
                <div class="align-items-stretch d-flex dropdown " id="lang-change">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon">
                            <img src="https://gmarketagents.com/public/assets/img/flags/en.png" height="11">
                        </span>
                    </a>
                    ...
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                <span class="d-block fw-500">Lê Thúy Vân</span>
                                <span class="d-block small opacity-60">seller</span>
                            </span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        <a href="https://gmarketagents.com/seller/profile" class="dropdown-item">
                            <i class="las la-user-circle"></i>
                            <span>Profile</span>
                        </a>

                        <a href="https://gmarketagents.com/logout" class="dropdown-item">
	...
	<script src="https://gmarketagents.com/public/assets/js/vendors.js" ></script>
	<script src="https://gmarketagents.com/public/assets/js/aiz-core.js" ></script>
        ...
        if ($('#lang-change').length > 0) {
            $('#lang-change .dropdown-menu a').each(function() {
                $(this).on('click', function(e){
                    ...
                    $.post('https://gmarketagents.com/language',{_token:'sY3tzsrJ2efBsz6gfCOaAFhO1F38qubVTunRAMoB', locale:locale}, function(data){
                        location.reload();
                    });
...
.arcontactus-widget .arcu-header-close{display:none!important}
</style>
	...
	window.addEventListener('load', function () {
		...
		$('#contact_us').contactUs({
			...
			items: [
				...
				{
				title: 'Zalo chat',
				//subTitle: 'https://www.livechat.com/expired-chat-link/?utm_source=expired_chat_link',
				...
				href: 'https://zalo.me/https://www.livechat.com/expired-chat-link/?utm_source=expired_chat_link',
				color: '#0165f8'
				},
				
				{
				title: 'Telegram',
				//subTitle: '@'+'@cskhnhauyen',
				...
				href: 'https://www.livechat.com/expired-chat-link/?utm_source=expired_chat_link',
				color: '#6685AD'
				},
...
<noscript><a href="https://www.livechat.com/chat-with/18598599/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>
