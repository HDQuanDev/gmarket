                        ...
                        <div class="card-body">
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    <?php
                                    $i=0;
                                    $sql=mysqli_query($conn,"SELECT * FROM products WHERE pos_id is not null and seller_id='$seller_id '");
                                    ...
                                    <tr>
                                        <td class="footable-first-visible" style="display: table-cell;">
                                            ...
                                            <?=$i?></td><td style="display: table-cell;">
                                             <a href="/products/<?=md5($row['id'])?>" target="_blank" class="text-reset">
                                        <?=$row['name']?>
                                        ...
                                        <td class="footable-last-visible" style="display: table-cell;"><?=$row['unit_price']?></td>
                                        <td style="display: none;"><span class="badge badge-inline badge-success">Approved</span></td><td style="display: none;">
                                ...
                                </td><td class="text-right" style="display: none;">
                                  <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="/seller/products/digitalproducts_edit.php?id=<?=$row['id']?>&lang=en" title="Edit">
                                      <i class="las la-edit"></i>
                                  </a>
                                  <!-- <a href="/seller/products/duplicate/<?=$row['id']?>" class="btn btn-soft-success btn-icon btn-circle btn-sm" title="Duplicate">
                                       <i class="las la-copy"></i>
                                  </a>
                                  <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="/seller/products/destroy/<?=$row['id']?>" title="Delete">
