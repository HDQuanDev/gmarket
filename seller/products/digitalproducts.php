...
<body class="">
            ...
            <div class="aiz-main-content">
                <div class="px-15px px-lg-25px">
                    ...
                    <div class="row gutters-10 justify-content-center">
                        <div class="col-md-4 mx-auto mb-3">
                            <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                                ...
                                <div class="px-3 pt-3 pb-3">
                                    <div class="h4 fw-700 text-center">49</div>
                        ...
                        <div class="col-md-4 mx-auto mb-3">
                            <a href="/seller/products/digitalproducts_create.php">
                                <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                                    <span class="size-60px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
                                        <i class="las la-plus la-3x text-white"></i>
                                    </span>
                                    <div class="fs-18 text-primary">Add New Digital Product</div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="/seller/seller-packages" class="text-center bg-white shadow-sm hov-shadow-lg text-center d-block p-3 rounded">
                                <img src="/public/uploads/all/6qfFN60o3OZkhXQERvwdqhvXVaworW0g4ZkowM72.jpg" height="44" class="mw-100 mx-auto">
                                <span class="d-block sub-title mb-2">Current Package: Bronze Shop</span>
                            ...
                            <table class="table aiz-table mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="md">Base Price</th>
                                ...
                                <tbody>
                                    <?php
                                    $sql=mysqli_query($conn,"SELECT * FROM products WHERE seller_id=$seller_id and type_product='digital' ORDER by id desc");
                                    while($row=fetch_assoc($sql)){
                                        $cate=fetch_array("SELECT * from categories WHERE id='{$row['category_id']}' LIMIT 1");
                                    ?>
                                    <tr>
                                        <td>1</td>
                                        <td><a href="/product/<?=md5($row['id'])?>" target="_blank" translate="no"><?=$row['name']?></a></td>
                                        <td translate="no">
                                            <?=$cate['name']?>
                                        </td>
                                        ...
                                        <td>
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input onchange="update_published(this)" value="<?=$row['id']?>" type="checkbox" <?=$row['published']?"checked":""?> >
                                        ...
                                        <td class="text-right">
                                            <a href="/seller/products/digitalproducts_edit.php?id=<?=$row['id']?>&lang=en" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="Edit">
                                                <i class="las la-edit"></i>
                                            </a>
                                            <!-- <a class="btn btn-soft-success btn-icon btn-circle btn-sm" href="" title="Download">
                                                <i class="las la-download"></i>
                                            </a> -->
                                            <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="/seller/products/digitalproducts_destroy.php?id=<?=$row['id']?>" title="Delete">
    ...
    <script type="text/javascript">
        function update_featured(el) {
            ...
            $.post('/seller/products/seller/featured', {
        ...
        function update_published(el) {
            ...
            $.post('/seller/products/published', {
                _token: 'QRLUoW1AMnSkkhBhHHYJFvoE9vsvOKYIyRGadUL7',
                id: el.value,
                status: status
            }, function(data) {
                if (data == 1) {
                    ...
                    AIZ.plugins.notify('danger', 'Please upgrade your package.');
                    location.reload();
                } else {
                    AIZ.plugins.notify('danger', 'Something went wrong!');
                    location.reload();
    ...
    <script type="text/javascript">
        // AIZ.plugins.notify('success', 'Digital Product has been inserted successfully');
