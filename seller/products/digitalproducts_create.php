        ...
        <div class="aiz-content-wrapper">
            ...
            <div class="aiz-main-content">
                <div class="px-15px px-lg-25px">
                    ...
                    ?>
                    <form class="" action="/seller/products/store.php" method="POST" enctype="multipart/form-data" id="choice_form">
                        <input type="hidden" name="_token" value="QRLUoW1AMnSkkhBhHHYJFvoE9vsvOKYIyRGadUL7"> <input type="hidden" name="added_by" value="seller">
                        ...
                        <div class="form-group mb-0 text-right mb-2">
                            <button type="submit" class="btn btn-primary" name="add_new">Save Product</button>
                        </div>
                    </form>
