...
<head>
	...
	<link rel="stylesheet" href="https://gmarket-quocte.com/public/assets/css/vendors.css">
    	<link rel="stylesheet" href="https://gmarket-quocte.com/public/assets/css/aiz-seller.css">
...
<body class="">
    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <div class="d-block text-center my-3">
                                    <img class="mw-100 mb-3" src="https://gmarket-quocte.com/public/uploads/all/3VOJb23uVlukILfyeStdC6LNJYO2lKPtROj3FN27.png" class="brand-icon"
                        alt="Gmarket Viet Nam">
                                <h3 class="fs-16  m-0 text-primary">ThangHim</h3>
                <p class="text-primary"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0c78646d626b6465613e4c6b616d6560226f6361">[email&#160;protected]</a></p>
            </div>
        </div>
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/dashboard" class="aiz-side-nav-link">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarket-quocte.com/seller/products"
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarket-quocte.com/seller/product-bulk-upload/index"
                                class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Product Bulk Upload</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarket-quocte.com/seller/digitalproducts"
                                class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Digital Products</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="https://gmarket-quocte.com/seller/reviews"
                                class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/uploads"
                        class="aiz-side-nav-link ">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="https://gmarket-quocte.com/seller/seller-packages" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">Packages</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="https://gmarket-quocte.com/seller/packages-payment-list" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                    <li class="aiz-side-nav-item">
                                        <a href="https://gmarket-quocte.com/seller/seller-through-train" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">Through Train</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="https://gmarket-quocte.com/seller/through-train-payment-list" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="https://gmarket-quocte.com/seller/pos"
                                    class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                                                        <a href="https://gmarket-quocte.com/seller/orders"
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/shop"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/payments"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/money-withdraw-requests"
                        class="aiz-side-nav-link ">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/money-recharge-requests"
                        class="aiz-side-nav-link ">
                        <i class="las la-money-bill-wave-alt aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">Money Recharge</span>
                    </a>
                </li>

                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/commission-history" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">Commission History</span>
                                                        ...
                                                        <li class="aiz-side-nav-item">
                        <a href="https://gmarket-quocte.com/seller/conversations"
                            class="aiz-side-nav-link ">
                            ...
                            <span class="aiz-side-nav-text">Conversations</span>
                                    ...
                                    <li class="aiz-side-nav-item">
                        <a href="https://gmarket-quocte.com/seller/product-queries"
                            class="aiz-side-nav-link ">
                            ...
                            <span class="aiz-side-nav-text">Product Queries</span>
                                ...
                                <li class="aiz-side-nav-item">
                    <a href="https://gmarket-quocte.com/seller/support_ticket"
                        class="aiz-side-nav-link ">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    ...
                    <div class="aiz-topbar-item">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-icon btn-circle btn-light" href="https://gmarket-quocte.com/seller/pos" target="_blank" title="POS">
                ...
                <div class="align-items-stretch d-flex dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg py-0">
                        ...
                        <div class="text-center border-top">
                            <a href="https://gmarket-quocte.com/seller/all-notification" class="text-reset d-block py-2">
                    ...
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                <span class="d-block fw-500">Thắng Hoàng</span>
                                <span class="d-block small opacity-60">seller</span>
                            </span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        <a href="https://gmarket-quocte.com/seller/profile" class="dropdown-item">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row gutters-5 mt-2">
                <div class="col text-md-left text-center">
                                            <address>
                            Name: <strong class="text-main">
                                Dmitry
                            </strong><br>
                            Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1470797d60666d212622252023547379757d783a777b79">[email&#160;protected]</a><br>
                            Phone: +7 8318526147<br>
                            Address: Novopolevaya Ulitsa, Nizhny Novgorod, Nizhny Novgorod Oblast, Russia, ,  385<br>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td class="text-info text-bold text-right">20241115-20431426</td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">Order status</td>
                                <td class="text-right">
                                                                            <span
                                            class="badge badge-inline badge-info">Confirmed</span>
                                                                    </td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">Order date</td>
                                <td class="text-right">15-11-2024 08:43 PM</td>
                            </tr>
                            <tr>
                ...
                <div class="col-lg-12 table-responsive">
                    <table class="table-bordered aiz-table invoice-summary table">
                        ...
                        <tbody>
                                    ...
                                    <td>1</td>
                                    <td>
                                                                                    <a href="https://gmarket-quocte.com/product/yg5mn-gfRDZ"
                                                target="_blank"><img height="50"
                                                    src="https://sc04.alicdn.com/kf/Ha390e12abfb24ee99fb2c80ff4f99afei.jpg"></a>
                                                                            </td>
                                    <td>
                                                                                    <strong><a href="https://gmarket-quocte.com/product/yg5mn-gfRDZ"
                                                    target="_blank"
                                                    class="text-muted">2022 Hot Sale Luxury Fashion New Printed Color Matching Shoulder Bag Women&#039;s Bag Fashion Tote Handbags One-Shoulder Handbags 16604</a></strong>
                                            <small></small>
                                                                            </td>
                                    <td>
                                                                                    Home Delivery
            ...
            <div class="clearfix float-right">
                ...
                <div class="no-print text-right">
                    <a href="https://gmarket-quocte.com/seller/invoice/2754" type="button"
	...
	<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://gmarket-quocte.com/public/assets/js/vendors.js" ></script>
	<script src="https://gmarket-quocte.com/public/assets/js/aiz-core.js" ></script>
        ...
        $('#update_delivery_status').on('change', function() {
            ...
            $.post('https://gmarket-quocte.com/seller/orders/update_delivery_status', {
        ...
        $('#update_payment_status').on('change', function() {
            ...
            $.post('https://gmarket-quocte.com/seller/orders/update_payment_status', {
                _token: 'eObVDgS1BnyzqUZf3wNmMehk2sbNi4MatBxDBYhn',
                order_id: order_id,
                status: status
            }, function(data) {
        ...
        if ($('#lang-change').length > 0) {
            $('#lang-change .dropdown-menu a').each(function() {
                $(this).on('click', function(e){
                    ...
                    $.post('https://gmarket-quocte.com/language',{_token:'eObVDgS1BnyzqUZf3wNmMehk2sbNi4MatBxDBYhn', locale:locale}, function(data){
                        location.reload();
                    });
