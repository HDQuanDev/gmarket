...
$items_query = "SELECT od.name,
    ...
    MAX(od.price * od.quantity) as item_total,
    COALESCE(MAX(p.thumbnail_image), MAX(od.img), '/public/assets/img/placeholder.jpg') as image_path
