...
<head>
    ...
    <script>
        ...
        AIZ.local = {
            ...
            file_selected: '<?=tran('File selected')?>',
            files_selected: 'Files selected',
            add_more_files: '<?=tran('Add more files')?>',
            adding_more_files: '<?=tran('Adding more files')?>',
                ...
                <div class="px-15px px-lg-25px">
                    ...
                    <div class="aiz-titlebar mt-2 mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="h3"><?=tran("Purchase Package List")?></h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header row gutters-5">
                            <div class="col">
                                <h5 class="mb-md-0 h6"><?=tran("All Purchase Package")?></h5>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table aiz-table mb-0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th width="30%"><?=tran("Package")?></th>
                                        <th data-breakpoints="md"><?=tran("Package Price")?></th>
                                        <th data-breakpoints="md"><?=tran("Payment Type")?></th>
                                        <th data-breakpoints="md"><?=tran("Status")?></th>
                                    </tr>
                                </thead>
        ...
        function menuSearch() {
            ...
            if (filter !== '') {
                ...
                if (items.length > 0) {
                    ...
                    $("#search-menu").html(`<li class="aiz-side-nav-item"><span	class="text-center text-muted d-block"><?=tran('Nothing found')?></span></li>`);
                }
            } else {
