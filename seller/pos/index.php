                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <div class="my-2 my-md-0">
                                                    <button type="button" class="btn btn-primary btn-block" onclick="orderConfirmation()">Add to Product</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div id="order-confirm" class="modal fade">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-xl">
            <div class="modal-content" id="variants">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="addToProduct()" class="btn btn-primary btn-base-3">Add to Product</button>
                ...
                $('#product-list').append(
                    `<div class="w-130px w-xl-180px w-xxl-210px mx-2">
                        <div class="card bg-white c-pointer product-card hov-container">
                            ...
                            <div class="add-plus absolute-full rounded overflow-hidden hov-box ${(data.data[i].digital == 0 && data.data[i].qty <= 0) ? 'c-not-allowed' : '' }" data-stock-id="${data.data[i].id}">
