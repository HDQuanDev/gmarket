...
$sp_id=$_GET['id'];
$support=fetch_array("SELECT * FROM supports WHERE id=$sp_id LIMIT 1");
                    ...
                    <div class="card">
                        <div class="card-header row gutters-5">
                            <div class="text-center text-md-left">
                                <h5 class="mb-md-0 h5"> <?=$support['code']?></h5>
                                <div class="mt-2">
                                    <span> <?=$seller_full_name?> </span>
                                    <span class="ml-2"> <?=$support['last_reply']?> </span>
                                    <span class="badge badge-inline badge-secondary ml-2"> <?=$support['status']?> </span>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="/seller/support_ticket/reply" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="VoszYTrT5jAV44lQYyZ8sVEOYJ6mTda1IJ34W3un"> <input type="hidden" name="ticket_id" value="24" required>
                                <input type="hidden" name="user_id" value="1776">
                                ...
                                <div class="form-group mb-0 text-right">
                                    <button type="submit" class="btn btn-sm btn-primary" onclick="submit_reply('pending')"><?=tran("Send Reply")?></button>
                                </div>
                            </form>
                            <div class="pad-top">
