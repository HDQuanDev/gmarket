                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control mb-3" placeholder="" name="element_0" required>
                                    </div>
                                </div> -->
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control mb-3" placeholder="Email" name="element_2" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <!-- <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control mb-3" placeholder="" name="element_6" required>
                                    </div>
                                </div> -->
