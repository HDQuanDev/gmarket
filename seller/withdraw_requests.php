                        ...
                        <div class="card-body">
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    <?php
                                    $i=0;
                                    $sql=mysqli_query($conn,"SELECT * FROM history_payment WHERE type='Withdraw' and seller_id='$seller_id' ORDEr by id ");
            ...
            <div class="modal-content">
                ...
                <?php } else { ?>
                    ...
                    if(isset($_POST['send1'])){
                        ...
                        if($amount>$seller_money){
                            echo "<script>AIZ.plugins.notify('danger', 'Tài khoản không đủ tiền' );</script>";
                        }
                        else{
                            @mysqli_query($conn,"INSERT into history_payment(type,amount,message,seller_id,create_date)values('Withdraw','$amount','$message','$seller_id','$createDate')");
                            @mysqli_query($conn,"UPDATE sellers SET money=money-$amount WHERE id='$seller_id' LIMIT 1");
                    ...
                    <form class="" action="" method="post">
                        ...
                        <div class="modal-body gry-bg px-3 pt-1">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" lang="en" class="form-control mb-3" name="amount" min="4"  placeholder="Amount" required="" step="0.01">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <textarea name="message" rows="2" class="form-control mb-3"></textarea>
                                </div>
                            </div>
