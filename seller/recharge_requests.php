...
if(isset($_POST['amount'])){
    ...
    $name_payment="PAYPAL";
    @mysqli_query($conn,"INSERT into history_payment(type,seller_id,name_payment,create_date,amount)values('Recharge','$seller_id','$name_payment','$createDate','$amount')");
...
<body class="">
    ...
    <div class="aiz-main-wrapper">
        ...
        <div class="aiz-content-wrapper">
                ...
                <div class="px-15px px-lg-25px">
                    ...
                    <div class="aiz-titlebar mt-2 mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="h3"><?=tran("Money Recharge")?></h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gutters-10">
                        ...
                        <div class="col-md-3 mb-4 mx-auto">
                            <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" onclick="show_request_modal()">
                                ...
                                <div class="fs-18 text-primary"><?=tran("Send Recharge Request")?></div>
                            </div>
                        </div>
          ...
          <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" onclick="show_request_zhuan()">
              ...
              <div class="fs-18 text-primary">Send Recharge Request</div>
          </div>
        </div>-->
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6"><?=tran("Logout")?></h5>
                        </div>
                        <div class="card-body">
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    <?php
                                    $i=0;
                                    $sql=mysqli_query($conn,"SELECT * FROM history_payment WHERE seller_id='$seller_id' ORDEr by id desc");
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$row['amount']?>$</td>
                                        <td>
                                            <span class=" badge badge-inline badge-<?=$status=='Pending'?"info":($status=='Success'?"success":"danger")?>"><?=$status?></span>
                                        </td>
                                        <td>
            ...
            <div class="modal-content">
                ...
                <style>
                    @media (max-width:600px) {
                        #offline_seller_package_purchase_modal_body .col-6 {
                            -ms-flex: 0 0 33.33%;
                            flex: 0 0 33.33%;
                            max-width: 33.33%;
                        }

                        #offline_seller_package_purchase_modal_body .fs-15 {
                            font-size: 0.7375rem !important
                        }
                    }

                    #manual_payment_data,
                    #manual_payment_data+.form-group {
                        display: none
                    }
                </style>
                <form class="" action="" method="post">
                    ...
                    <div class="modal-body gry-bg px-3 pt-0">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="number" lang="en" class="form-control mb-3" step="0.01" name="amount" min="" placeholder="Amount" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <label><?=tran("Transaction ID")?></label>
                            </div>
                            <div class="col-md-9">
                                <input name="message" rows="8" class="form-control mb-3" />
                            </div>
                        </div>
                        <div class="form-group text-right">
                            <button type="submit" class="btn btn-sm btn-primary"><?=tran("Send")?></button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div id="delete-modal" class="modal fade">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title h6"><?=tran("Logout")?>Delete Confirmation</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                </div>
                <div class="modal-body text-center">
                    <p class="mt-1"><?=tran("Logout")?>Are you sure to delete this?</p>
                    <button type="button" class="btn btn-link mt-2" data-dismiss="modal"><?=tran("Logout")?>Cancel</button>
                    <a href="" id="delete-link" class="btn btn-primary mt-2"><?=tran("Logout")?>Delete</a>
                </div>
            </div>
        </div>
    </div><!-- /.modal -->
    ...
    <script type="text/javascript">
        ...
        function show_message_modal(id) {
            $.post('/admin/recharge_request/message_modal', {
                _token: 'c6MXnpe4lPP7N32uzv6W24NEiPEWxjq4Y54fVWYP',
                id: id
            }, function(data) {
                $('#message_modal .modal-content').html(data);
        ...
        $.post('/seller/api/offline_seller_package_purchase_modal.php', {
            _token: 'c6MXnpe4lPP7N32uzv6W24NEiPEWxjq4Y54fVWYP'
        }, function(data) {
