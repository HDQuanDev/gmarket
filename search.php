...
if (isset($_GET['keyword']) && $_GET['keyword'] != "") {
    ...
    $url = "https://gmarket-quocte.com/search?keyword=$keyword&page=$page";
                        ...
                        <div class="col-xl-3">
                            <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                                ...
                                <div class="collapse-sidebar c-scrollbar-light text-left">
                                    ...
                                    <div class="bg-white shadow-sm rounded mb-3">
                                        ...
                                        <div class="collapse show" id="collapse_1">
                                            ...
                                            <ul class="p-3 list-unstyled">
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/ladies-clothing-krads">Ladies clothing</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Mens-clothing-PjXnt">Men&#039;s clothing</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Electronics---Refrigeration-kLq7t">Electronics - Refrigeration</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Mother-and-baby-items-9i2Pd">Mother and baby items</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Jewelry--Watches-xOQVq">Jewelry &amp; Watches</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Smart-Phone-Tablet-and-Accessory-U5HXI">Smart Phone, Tablet and Accessory</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Sports-LfVLy">Sports</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Toy-XP5JU">Toy</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Beauty-salons-WTqSq">Beauty salons</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Shoes-LmXKs">Shoes</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Interior---Decoration-aVCL4">Interior - Decoration</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Pet-accessories-CBfbh">Pet accessories</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Home-electric-CGtoG">Home electric</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Perfume-WaXkw">Perfume</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Cars---Motorcycles---Bicycles---Accessories-S2Kbx">Cars - Motorcycles - Bicycles - Accessories</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Camera-Camcorder-GSpQB">Camera Camcorder</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Kitchen-accessories-oTJox">Kitchen accessories</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Fashion-accessories-PIooc">Fashion accessories</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Nail-and-eyelash-accessories-3tPBc">Nail and eyelash accessories</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Baby-shoes-TiYzt">Baby shoes</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Functional-foods---Health-UKQv4">Functional foods - Health</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Nutritional-milk-ZUMTn">Nutritional milk</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Backpack---Suitcase-N3IgD">Backpack - Suitcase</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Hand-Bag-diwHi">Hand Bag</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Snacks-I6xz3">Snacks</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Beer---Wine---Drinks-Ijpz0">Beer - Wine - Drinks</a>
                                                </li>
                                                <li class="mb-2 ml-2">
                                                    <a class="text-reset fs-14" href="/category/Souvenir-5McpP">Souvenir</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white shadow-sm rounded mb-3">
                                        <div class="fs-15 fw-600 p-3 border-bottom">
                                            <a href="#" class="dropdown-toggle text-dark filter-section collapsed" data-toggle="collapse" data-target="#collapse_Weight">
                                                Filter by Weight
                                            </a>
                                        </div>
                                        <div class="collapse" id="collapse_Weight">
                                            <div class="p-3  aiz-checkbox-list">
                                                <label class="aiz-checkbox">
                                                    <input
                                                        type="checkbox"
                                                        name="selected_attribute_values[]"
                                                        value="140 package" onchange="filter()">
                                                    <span class="aiz-square-check"></span>
                                                    <span>140 package</span>
                                                </label>
                                                <label class="aiz-checkbox">
                                                    <input
                                                        type="checkbox"
                                                        name="selected_attribute_values[]"
                                                        value="210 chip" onchange="filter()">
                                                    <span class="aiz-square-check"></span>
                                                    <span>210 chip</span>
                                                </label>
                                                <label class="aiz-checkbox">
                                                ...
                                                <label class="aiz-checkbox">
                                                    <input
                                                        type="checkbox"
                                                        name="selected_attribute_values[]"
                                                        value="140 chip" onchange="filter()">
                                                    <span class="aiz-square-check"></span>
                                                    <span>140 chip</span>
                                                </label>
                                                <label class="aiz-checkbox">
                                                ...
                                                <label class="aiz-checkbox">
                                                    <input
                                                        type="checkbox"
                                                        name="selected_attribute_values[]"
                                                        value="70 sheet" onchange="filter()">
                                                    <span class="aiz-square-check"></span>
                                                    <span>70 sheet</span>
                                                </label>
                                                <label class="aiz-checkbox">
                                    ...
                                    <div class="bg-white shadow-sm rounded mb-3">
                                        <div class="fs-15 fw-600 p-3 border-bottom">
                                            <a href="#" class="dropdown-toggle text-dark filter-section collapsed" data-toggle="collapse" data-target="#collapse_Variation">
                                                Filter by Variation
                                            </a>
                                        </div>
                                        <div class="collapse" id="collapse_Variation">
                                            <div class="p-3  aiz-checkbox-list">
                                                <label class="aiz-checkbox">
                                                    <input
                                                        type="checkbox"
                                                        name="selected_attribute_values[]"
                                                        value="1 With 3 Samples" onchange="filter()">
                                                    <span class="aiz-square-check"></span>
                                                    <span>1 With 3 Samples</span>
                                                </label>
                                                <label class="aiz-checkbox">
                                                    <input
                                                        type="checkbox"
                                                        name="selected_attribute_values[]"
                                                        value="1 With Mini Serum Cream" onchange="filter()">
                                                    <span class="aiz-square-check"></span>
                                                    <span>1 With Mini Serum Cream</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-9">
                            ...
                            <ul class="breadcrumb bg-transparent p-0">
                                <li class="breadcrumb-item opacity-50">
                                    <a class="text-reset" href=""><?=tran("Home")?></a>
                                </li>
                                <li class="breadcrumb-item fw-600  text-dark">
                                    <a class="text-reset" href="/search">"<?=tran("All categories")?>"</a>
                                </li>
                            </ul>
                            ...
                            <div class="text-left">
                                <div class="row gutters-5 flex-wrap align-items-center">
                                    ...
                                    <div class="col-6 col-lg-auto mb-3 w-lg-200px">
                                        <label class="mb-0 opacity-50"><?=tran("Brands")?></label>
                                        <select class="form-control form-control-sm aiz-selectpicker" data-live-search="true" name="brand" onchange="filter()">
                                            <option value=""><?=tran("All Brands")?></option>
                                            <?php
                                    ...
                                    <div class="col-6 col-lg-auto mb-3 w-lg-200px">
                                        <label class="mb-0 opacity-50"><?=tran("Sort by")?></label>
                                        <select class="form-control form-control-sm aiz-selectpicker" name="sort_by" onchange="filter()">
                                            <option value="newest"><?=tran("Newest")?></option>
                                            <option value="oldest"><?=tran("Oldest")?></option>
                                            <option value="price-asc"><?=tran("Price low to high")?></option>
                                            <option value="price-desc"><?=tran("Price high to low")?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gutters-5 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                                ...
                                <?php
                                $sql = mysqli_query($conn, "SELECT * FROM products WHERE lower(name) LIKE lower('%$keyword%')");
                                        ...
                                        <div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                            <div class="position-relative">
                                                <a href="/product/<?=$row['id']?>" class="d-block">
                                                    <img class="img-fit mx-auto h-140px h-md-210px lazyloaded" src="/public/uploads/all/<?=$file['src']?>" data-src="/public/uploads/all/nTehoiE5yh5lgQq1jYpO1ks9uUp31JhuNjBRWYLk.png" alt="Vedition Dog Food for All Ages Intestinal Health Functional Semi-moisturized Duck Meat" onerror="this.onerror=null;this.src='https://www.gmarket.co.kr/public/assets/img/placeholder.jpg';">
                                                </a>
                                            ...
                                            <div class="p-md-3 p-2 text-left">
                                                <div class="fs-15">
                                                    <span class="fw-700 text-primary"><?=currency($row['unit_price']*($_SESSION['currency']!='USD'?25000:1))?><?=$_SESSION['currency_character']?></span>
                                                </div>
                                ...
                                foreach ($elements as $element) {
                                    foreach ($element->childNodes as $child) {
                                        // In ra thẻ con
                                        if ($child->nodeType === XML_ELEMENT_NODE) {
                                            $c = str_replace("https://gmarket-quocte.com/product/", "/product/", $dom->saveHTML($child));
                                            if($_SESSION['currency_character']!='$')$c = str_replace("$", $_SESSION['currency_character'], $c);
                            ...
                            <div class="aiz-pagination aiz-pagination-center mt-4">
                                <nav>
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item"><a class="page-link" href="/search?keyword=<?=isset($_GET['keyword'])?$_GET['keyword']:""?>&page=2">2</a></li>
                                        <li class="page-item"><a class="page-link" href="/search?keyword=<?=isset($_GET['keyword'])?$_GET['keyword']:""?>&page=3">3</a></li>
                                        <li class="page-item"><a class="page-link" href="/search?keyword=<?=isset($_GET['keyword'])?$_GET['keyword']:""?>&page=4">4</a></li>

                                        <li class="page-item disabled" aria-disabled="true"><span class="page-link">...</span></li>


                                        <li class="page-item"><a class="page-link" href="/search?keyword=<?=isset($_GET['keyword'])?$_GET['keyword']:""?>&page=20">20</a></li>
                                        <li class="page-item"><a class="page-link" href="/search?keyword=<?=isset($_GET['keyword'])?$_GET['keyword']:""?>&page=21">21</a></li>


                                        <li class="page-item">
                                            <a class="page-link" href="/search?keyword=<?=isset($_GET['keyword'])?$_GET['keyword']:""?>&page=<?=$page+1?>" rel="next" aria-label="Next »">&rsaquo;</a>
                                        </li>
                                    </ul>
                                </nav>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-3 col-md-6">
                        <a class="text-reset border-left text-center p-4 d-block" href="https://www.gmarket.co.kr/terms">
                            <i class="la la-file-text la-3x text-primary mb-2"></i>
                            <h4 class="h6">Terms &amp; conditions</h4>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <a class="text-reset border-left text-center p-4 d-block" href="https://www.gmarket.co.kr/return-policy">
                            <i class="la la-mail-reply la-3x text-primary mb-2"></i>
                            <h4 class="h6">Return policy</h4>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <a class="text-reset border-left text-center p-4 d-block" href="https://www.gmarket.co.kr/support-policy">
                            <i class="la la-support la-3x text-primary mb-2"></i>
                            <h4 class="h6">Support Policy</h4>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <a class="text-reset border-left border-right text-center p-4 d-block" href="https://www.gmarket.co.kr/privacy-policy">
            ...
            if ($('#lang-change').length > 0) {
                $('#lang-change .dropdown-menu a').each(function() {
                    $(this).on('click', function(e) {
                        ...
                        $.post('https://www.gmarket.co.kr/language', {
                            _token: AIZ.data.csrf,
                            locale: locale
                        }, function(data) {
                            location.reload();
