                    ...
                    <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
                        <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                            <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                                ...
                                <div class="text-truncate opacity-60"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0a3b38393e3f3c4a6d246d">[email&#160;protected]</a></div>
                            </div>
                            ...
                            <div class="card-body">
                                <table class="table aiz-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="/purchase_history_detail.php?id=<?=$row['id']?>">20241010-11342962</a>
                                            </td>
                                            <td>10-10-2024</td>
                                            <td>
                                                849.15$
                                            ...
                                            <td class="text-right">
                                                <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="https://tmdtquocte.com/purchase_history/destroy/5824" title="Cancel">
                                                    <i class="las la-trash"></i>
                                                </a>
                                                <a href="/purchase_history_detail.php?id=<?=$row['id']?>" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="Order Details">
                                                    <i class="las la-eye"></i>
                                                </a>
                                                <a class="btn btn-soft-warning btn-icon btn-circle btn-sm" href="https://tmdtquocte.com/invoice/5824" title="Download Invoice">
